...
from Builder.Debug import count_time, global_anlyzer as anl
...
class Project(ProjectBase):
    ...
    @triggers('project.impoort.structures')
    def __init_import_structures(self):
        anl.phase('导入构件')
        self.__env['components'].update(Loader.load_compoents(f'{self.base_path}{PATH_SEP}Structures{PATH_SEP}Components'))
        anl.phase('导入卡片模版')
        self.__env['templates'].update(Loader.load_tempaltes(f'{self.base_path}{PATH_SEP}Structures{PATH_SEP}Templates'))
        anl.phase('导入页面模版')
        self.__env['page_templates'].update(Loader.load_page_tempaltes(f'{self.base_path}{PATH_SEP}Structures{PATH_SEP}PageTemplates'))
    ...
    def __init_import_resources(self):
        ...
        self.__env['resources'].update(Loader.load_resources(f'{self.base_path}{PATH_SEP}Resources'))
