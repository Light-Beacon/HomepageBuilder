from .client import PCLClient, PCLClientLimiter, PCLBranch

FIXED_SWAPPED_TYPO_VERSIONS = PCLClientLimiter()
FIXED_SWAPPED_TYPO_VERSIONS.add_rule(PCLBranch.OFFICIAL, ('2.10.6',...))
FIXED_SWAPPED_TYPO_VERSIONS.add_rule(PCLBranch.OPEN_SOURCE, ('2.10.6',...))
